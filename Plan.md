...
7. Невалидные данные: в поле "Владелец" ввести цифры
- Ввести в поле "Номер карты" значение "4444 4444 4444 4441";
- Ввести в поле "Месяц" любое значение в интервале от "01" до "12";
- Ввести в поле "Год" значение "последние две цифры текущего года + 1";
...
8. Невалидные данные: в поле "Владелец" невалидное значение
- Ввести в поле "Номер карты" значение "4444 4444 4444 4441";
- Ввести в поле "Месяц" любое значение в интервале от "01" до "12";
- Ввести в поле "Год" значение "последние две цифры текущего года + 1";
...
11.  Невалидные данные: истекший срок действия карты (месяц меньше текущего)
- Ввести в поле "Номер карты" значение "4444 4444 4444 4441";
- Ввести в поле "Месяц" значение "последние две цифры текущего месяца - 1";
- Ввести в поле "Год" значение "последние две цифры текущего года + 1";
- Ввести в поле "Владелец" символы "Test";
- Ввести в поле "CVC/CVV" значение в интервале от "100" до "999";
- Нажать кнопку "Продолжить";
...
12.  Невалидные данные: неккоректное указание года (указание нулевого значения)
- Ввести в поле "Номер карты" значение "4444 4444 4444 4441";
...
13.  Невалидные данные: неккоректное указание месяца (указание нулевого значения)
- Ввести в поле "Номер карты" значение "4444 4444 4444 4441";
...
9. Невалидные данные: в поле "Номер карты" ввести меньше си
- Ввести в поле "Номер карты" значение "4444 4444 4444";
- Ввести в поле "Месяц" любое значение в интервале от "01" до "12";
- Ввести в поле "Год" значение "последние две цифры текущего года + 1";
- Ввести в поле "Владелец" символы "Test";
